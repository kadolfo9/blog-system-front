...
import { Delete, FormatAlignLeft, Mode } from "@mui/icons-material";
import { Container, Paper, TableContainer, Table, TableHead, TableCell, TableBody, TableRow, Button } from "@mui/material";
    ...
    const postList = posts.posts?.map(post => (
        ...
        >
            ...
            <TableCell align="right">
                <Button variant="contained" endIcon={<FormatAlignLeft />}>Detalhes</Button>
            </TableCell>
            <TableCell align="right">
